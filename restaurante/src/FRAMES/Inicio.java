...
public class Inicio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        registrar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/btn_Registrarse.png"))); // NOI18N
        registrar.setBorder(null);
        registrar.setBorderPainted(false);
        registrar.setContentAreaFilled(false);
        registrar.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/img/btn_RegistrarseSecundario.png"))); // NOI18N
        ...
        getContentPane().add(registrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 560, 340, 50));
        ...
        getContentPane().add(tp_contra, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 370, 280, 30));

        tf_contra.setText("jTextField1");
        ...
        getContentPane().add(tf_Usuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 290, 290, 40));
